...
// Usage:
//   node season.mjs
//   node season.mjs moltopoly_out
//   node season.mjs moltopoly_out --last 50
//   node season.mjs moltopoly_out --minVersion 0.7
  ...
  <div class="kpi">
    ...
    <div class="card">
      ...
      <div style="margin-top:8px" class="mono">
        ...
        It scans: <span class="muted">moltopoly_out/match_*.json</span><br/>
...
function main() {
  const OUT_DIR = process.argv[2] && !process.argv[2].startsWith("--") ? process.argv[2] : "moltopoly_out";
